...
export default function DirtWorkGradingPage() {
    ...
    const services = [
        {
            ...
            description: 'Laser-guided grading for perfect slopes and drainage patterns.',
            icon: Compass,
            features: ['Laser level accuracy', 'Proper drainage slope', 'Soil compaction', 'Final smoothing'],
        },
        {
            title: 'Site Preparation',
            description: 'Complete site clearing and preparation for construction or landscaping.',
            icon: Tractor,
            features: ['Tree/brush removal', 'Rock excavation', 'Soil stabilization', 'Debris hauling'],
        },
        {
            title: 'Excavation Services',
            description: 'Professional excavation for foundations, pools, and landscape features.',
            icon: Drill,
            features: ['Precise digging', 'Trenching', 'Backfilling', 'Spoil management'],
        },
        {
            title: 'Yard Regrading',
            description: 'Correct poor drainage by reshaping your yard with proper slopes.',
            icon: Mountain,
            features: ['Drainage correction', 'Soil import/export', 'Erosion control', 'Final grading'],
        },
        {
            title: 'Driveway Preparation',
            description: 'Proper base preparation for durable driveways and parking areas.',
            icon: Truck,
            features: ['Subbase compaction', 'Proper crown', 'Drainage channels', 'Edge preparation'],
        },
        {
            title: 'Heavy Equipment Operation',
            description: 'Expert operation of excavators, bulldozers, and skid steers.',
            icon: Tractor,
            features: ['Skilled operators', 'Right equipment selection', 'Efficient operation', 'Site protection'],
        }
    ];
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-linear-to-br from-white to-amber-50/30">
                    ...
                    <div className="container mx-auto px-4 md:px-8 lg:px-12">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                            ...
                            >
                                ...
                                >
                                    <span className="text-yellow-400 block mb-2">Precision Earthmoving</span>
                                    <span className="text-white block">Professional Dirt Work & Grading</span>
                                </motion.h1>
                                ...
                                >
                                    <p>25+ years of heavy equipment experience for perfect results every time.</p>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span className="text-center">
                                            <span className="block text-lg">FREE SITE EVALUATION</span>
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>Laser-Guided Precision</span>
                                    </div>
                                </motion.div>
                            </motion.div>
                ...
                <section className="py-20 bg-linear-to-br from-amber-50/50 to-yellow-50/50">
                    <div className="container mx-auto px-4 md:px-8 lg:px-12">
                        ...
                        >
                            <div className="space-y-8">
                                {[
                                    { label: 'Projects Completed', value: '1,000+', percent: 100 },
                                    { label: 'Customer Satisfaction', value: '98%', percent: 98 },
                                    { label: 'Precision Grading', value: 'Laser-Guided', percent: 100 }
                                ].map((stat, index) => (
                                    <div key={index}>
                ...
                {/* CTA Banner */}
                <section className="py-20 bg-linear-to-r from-amber-600/10 to-yellow-600/10">
                    <div className="container mx-auto px-4 md:px-6 lg:px-8">
                        <motion.div
                            className="bg-linear-to-r from-amber-600 to-yellow-600 rounded-3xl shadow-2xl overflow-hidden"
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            transition={{ duration: 0.6 }}
                        >
                            <div className="grid grid-cols-1 lg:grid-cols-2">
                                ...
                                <div className="p-12 bg-white flex flex-col justify-center">
                                    <h3 className="text-[27px] font-bold text-gray-900 mb-8 text-center">Get Your Free Site Evaluation</h3>
