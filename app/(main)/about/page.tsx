...
import { Award, Users, Clock, Shield, Star, MapPin, Heart, Target, ThumbsUp, Phone } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold">#1 IN NORTHEST ARKANSAS</span>
            </motion.div>
